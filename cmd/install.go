...
var installCmd = &cobra.Command{
	Use:   "install <datapack name>",
	Short: "Install a datapack",
	Long:  `Install a datapack from the Dpackage website`,
...
func init() {
	...
	//installCmd.PersistentFlags().String("test", "", "test")
	installCmd.PersistentFlags().StringVarP(&World, "world", "w", "", "World name")
}
